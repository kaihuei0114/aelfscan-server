...
public class MongoDbAElfScanServerDbSchemaMigrator : IAElfScanServerDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbAElfScanServerDbSchemaMigrator(IServiceProvider serviceProvider)
    {
